...
let getTagMessage = tag => {
    let tagId = $git.line(["show-ref", "--tags", "-s", $v.tagName(tag)]);
...
let getTagMessageAsync = tag => {
    return new Promise((resolve, reject) => {
        $cp.execFile("git", ["show-ref", "--tags", "-s", $v.tagName(tag)],
...
let getTagTime = tag => {
    let time = $git.line(["tag", "-l", "--format=%(taggerdate:iso-strict)", $v.tagName(tag)]);
...
exports.parseTagMessage = parseTagMessage;
exports.getTagMessage = getTagMessage;
exports.getTagMessageAsync = getTagMessageAsync;
exports.getTagTime = getTagTime;
exports.generateTagLabel = generateTagLabel;
exports.getTagHash = getTagHash;
