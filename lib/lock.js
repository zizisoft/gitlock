...
class BaseLock extends Lock {
    ...
    _joinContentBeforeAndAfter(str) {
        if (
            (this.contentBefore === "" || this.contentBefore.endsWith("\n\n")) &&
            str === "" &&
            this.contentAfter.startsWith("\n")
        ) {
            return this.contentBefore + str + this.contentAfter.substr(1);
        }
        else {
            return this.contentBefore + str + this.contentAfter;
        }
    }
