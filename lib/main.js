...
let FAKE_TIME_ORIGIN = "2005-04-08T00:00:00Z";
...
let addLocks = () => {
    ...
    let loadAllLocks = () => {
        ...
        lines.forEach(line => {
            ...
            let timespan = $util.subtractTime(time, fakeTime);
    ...
    let traverse = commitId => {
        ...
        if (commit.isNew) {
            ...
            fakeTime = $util.addTime(fakeTime, 2);
            $lock.add(
